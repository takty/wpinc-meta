...
if ( ! function_exists( '\wpinc\get_multiple_post_meta_from_env' ) ) {
	/**
...
if ( ! function_exists( '\wpinc\get_multiple_post_meta' ) ) {
	/**
...
if ( ! function_exists( '\wpinc\set_multiple_post_meta' ) ) {
	/**
